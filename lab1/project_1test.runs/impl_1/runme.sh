...
HD_PWD='C:/Users/brain/project_1test/project_1test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_locktop_async.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_locktop_async.tcl -notrace
