...
HD_PWD='C:/Users/brain/project_1test/project_1test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_locktop_async.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_locktop_async.tcl
