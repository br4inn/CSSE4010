...
HD_PWD='C:/Users/brain/lab3/lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Header.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Header.tcl -notrace
